...
- **Select:** Hold the left mouse button anywhere near your units to grow a selection circle. Release to select friendly units inside the circle (the longer you hold, the larger the circle).
- **Move:** Right-click to send the selected squad to the clicked location. Units spread into a SC2-style formation so they don’t overlap.
